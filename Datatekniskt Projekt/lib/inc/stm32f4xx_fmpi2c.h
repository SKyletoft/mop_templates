 ...
 * @brief   This file contains all the functions prototypes for the I2C Fast
 *Mode Plus firmware library.
 ******************************************************************************
 * @attention
 *
...
typedef struct {
	...
	uint32_t FMPI2C_AnalogFilter; /*!< Enables or disables analog noise
	                                filter. This parameter can be a value of
	                                @ref FMPI2C_Analog_Filter */
	...
	uint32_t
	    FMPI2C_Mode; /*!< Specifies the FMPI2C mode.
	...
	uint32_t FMPI2C_AcknowledgedAddress; /*!< Specifies if 7-bit or 10-bit
...
#define IS_FMPI2C_ACK(ACK)                                                   \
	(((ACK) == FMPI2C_Ack_Enable) || ((ACK) == FMPI2C_Ack_Disable))
/**
 * @}
 */
