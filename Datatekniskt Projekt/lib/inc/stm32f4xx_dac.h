...
typedef struct {
	uint32_t DAC_Trigger; /*!< Specifies the external trigger for the selected
	                         DAC channel. This parameter can be a value of
	                         @ref DAC_trigger_selection */

	uint32_t
	    DAC_WaveGeneration; /*!< Specifies whether DAC channel noise waves or
	                           triangle waves are generated, or whether no
	                           wave is generated. This parameter can be a
	                           value of @ref DAC_wave_generation */

	uint32_t
	    DAC_LFSRUnmask_TriangleAmplitude; /*!< Specifies the LFSR mask for
	                                         noise wave generation or the
	                                         maximum amplitude triangle
	...
	uint32_t
	    DAC_OutputBuffer; /*!< Specifies whether the DAC channel output buffer
...
#define DAC_Trigger_None                                                     \
	((uint32_t) 0x00000000) /*!< Conversion is automatic once the            \
	                           DAC1_DHRxxxx register has been loaded, and    \
	                           not by external trigger */
...
#define DAC_Trigger_Software                                                 \
	((uint32_t) 0x0000003C) /*!< Conversion started by software trigger for  \
	                           DAC channel */
