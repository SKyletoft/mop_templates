...
typedef struct {
	...
	uint32_t LPTIM_Waveform; /*!< Selects the output shape.
	                         This parameter can be a value of @ref
	                         LPTIM_Waveform_Shape */

	uint32_t LPTIM_OutputPolarity; /*!< Specifies the LPTIM Output pin
	                               polarity. This parameter can be a value of
	                               @ref LPTIM_Output_Polarity */
} LPTIM_InitTypeDef;
...
#define IS_LPTIM_IT(IT)                                                      \
	(((IT) == LPTIM_IT_DOWN) || ((IT) == LPTIM_IT_UP)                        \
	 || ((IT) == LPTIM_IT_ARROK) || ((IT) == LPTIM_IT_CMPOK)                 \
	 || ((IT) == LPTIM_IT_EXTTRIG) || ((IT) == LPTIM_IT_ARRM)                \
	 || ((IT) == LPTIM_IT_CMPM))
...
/** @defgroup LPTIM_Option_Register_Definition LPTIM Option Register
 * Definition
 * @{
 */
