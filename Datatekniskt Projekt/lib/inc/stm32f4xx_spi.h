...
typedef struct {
	uint16_t SPI_Direction; /*!< Specifies the SPI unidirectional or
	                           ...
	                           a value of @ref SPI_data_direction */
	...
	uint16_t SPI_BaudRatePrescaler; /*!< Specifies the Baud Rate prescaler
	                                   value which will be used to configure
	                                   the transmit and receive SCK clock.
	                                     This parameter can be a value of @ref
	                                   SPI_BaudRate_Prescaler
	                                     @note The communication clock is
	                                   derived from the master clock. The
...
typedef struct {
	...
	uint16_t I2S_DataFormat; /*!< Specifies the data format for the I2S
	                            ...
	                            of @ref I2S_Data_Format */

	uint16_t I2S_MCLKOutput; /*!< Specifies whether the I2S MCLK output is
	                            enabled or not. This parameter can be a value
	                            of @ref I2S_MCLK_Output */
