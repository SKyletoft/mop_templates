...
typedef struct {
	uint32_t
	    AutomaticClockLaneControl; /*!< Automatic clock lane control
...
typedef struct {
	...
	uint32_t HorizontalBackPorch; /*!< Horizontal back-porch duration (in lane
	                                 byte clock cycles)         */

	uint32_t HorizontalLine; /*!< Horizontal line duration (in lane byte clock
	                            cycles)               */
	...
	uint32_t LPVACTLargestPacketSize; /*!< The size, in bytes, of the low
	                                     power largest packet that can fit in
	                                     a line during VACT region */

	uint32_t
	    LPHorizontalFrontPorchEnable; /*!< Low-power horizontal front-porch
	...
	uint32_t
	    FrameBTAAcknowledgeEnable; /*!< Frame bus-turn-around acknowledge
...
typedef struct {
	...
	uint32_t CommandSize; /*!< Maximum allowed size for an LTDC write memory
	                         ...
	                         be any value between 0x00 and 0xFFFF   */
...
typedef struct {
	...
	uint32_t
	    LPGenShortWriteOneP; /*!< Generic Short Write One parameter
	                            Transmission This parameter can be any value
	                            of @ref DSI_LP_LPGenShortWriteOneP */

	uint32_t
	    LPGenShortWriteTwoP; /*!< Generic Short Write Two parameters
	                            Transmission This parameter can be any value
...
typedef struct {
	...
	uint32_t DataLaneMaxReadTime; /*!< The maximum time required to perform a
	                                 read command */

	uint32_t StopWaitTime; /*!< The minimum wait period to request a
 ...
 */
#define DSI_RGB565                                                           \
	((uint32_t) 0x00000000) /*!< The values 0x00000001 and 0x00000002 can    \
	                           also be used for the RGB565 color mode        \
	                           configuration */
#define DSI_RGB666                                                           \
	((uint32_t) 0x00000003) /*!< The value 0x00000004 can also be used for   \
	                           the RGB666 color mode configuration */
...
#define DSI_DCS_LONG_PKT_WRITE                                               \
	((uint32_t) 0x00000039) /*!< DCS long write     */
#define DSI_GEN_LONG_PKT_WRITE                                               \
	((uint32_t) 0x00000029) /*!< Generic long write */
...
#define DSI_ERROR_ACK                                                        \
	((uint32_t) 0x00000001) /*!< acknowledge errors          */
#define DSI_ERROR_PHY                                                        \
	((uint32_t) 0x00000002) /*!< PHY related errors          */
#define DSI_ERROR_TX                                                         \
	((uint32_t) 0x00000004) /*!< transmission error          */
#define DSI_ERROR_RX                                                         \
	((uint32_t) 0x00000008) /*!< reception error             */
#define DSI_ERROR_ECC                                                        \
	((uint32_t) 0x00000010) /*!< ECC errors                  */
#define DSI_ERROR_CRC                                                        \
	((uint32_t) 0x00000020) /*!< CRC error                   */
#define DSI_ERROR_PSE                                                        \
	((uint32_t) 0x00000040) /*!< Packet Size error           */
#define DSI_ERROR_EOT                                                        \
	((uint32_t) 0x00000080) /*!< End Of Transmission error   */
#define DSI_ERROR_OVF                                                        \
	((uint32_t) 0x00000100) /*!< FIFO overflow error         */
#define DSI_ERROR_GEN                                                        \
	((uint32_t) 0x00000200) /*!< Generic FIFO related errors */
/**
 * @}
 */
...
/* Alias for compatibility with STM32F4XX Standard Peripherals Library version
 * number V1.6.0 */
