...
typedef struct {
	...
	uint8_t CAN_BS2; /*!< Specifies the number of time quanta in Bit
	                    Segment 2. This parameter can be a value of @ref
	...
	FunctionalState CAN_AWUM; /*!< Enable or disable the automatic wake-up
	                             mode. This parameter can be set either to
	                             ENABLE or DISABLE. */

	FunctionalState CAN_NART; /*!< Enable or disable the non-automatic
	                             retransmission mode. This parameter can be
	                             set either to ENABLE or DISABLE. */

	FunctionalState CAN_RFLM; /*!< Enable or disable the Receive FIFO Locked
	                             mode. This parameter can be set either to
	                             ENABLE or DISABLE. */
...
typedef struct {
	...
	uint16_t
	    CAN_FilterMaskIdLow; /*!< Specifies the filter mask number or
	                            identification number, according to the mode
	                            (LSBs for a 32-bit configuration, second one
	                            for a 16-bit configuration). This parameter
	                            can be a value between 0x0000 and 0xFFFF */

	uint16_t CAN_FilterFIFOAssignment; /*!< Specifies the FIFO (0 or 1) which
	                                      will be assigned to the filter.
	                                            This parameter can be a value
	                                      of @ref CAN_filter_FIFO */

	uint8_t CAN_FilterNumber; /*!< Specifies the filter which will be
	                             initialized. It ranges from 0 to 13. */
...
typedef struct {
	...
	uint8_t Data[8]; /*!< Contains the data to be transmitted. It ranges from
	                    0 to 0xFF. */
} CanTxMsg;
...
typedef struct {
	...
	uint8_t Data[8]; /*!< Contains the data to be received. It ranges from 0
	                    to 0xFF. */
...
#define CAN_InitStatus_Success                                               \
	((uint8_t) 0x01) /*!< CAN initialization OK                              \
	                  */
...
#define CAN_TxStatus_Pending                                                 \
	((uint8_t) 0x02) /*!< CAN transmission pending                           \
	                  */
...
#define CAN_FLAG_FF0                                                         \
	((uint32_t) 0x32000008) /*!< FIFO 0 Full Flag            */
#define CAN_FLAG_FOV0                                                        \
	((uint32_t) 0x32000010) /*!< FIFO 0 Overrun Flag         */
#define CAN_FLAG_FMP1                                                        \
	((uint32_t) 0x14000003) /*!< FIFO 1 Message Pending Flag */
#define CAN_FLAG_FF1                                                         \
	((uint32_t) 0x34000008) /*!< FIFO 1 Full Flag            */
#define CAN_FLAG_FOV1                                                        \
	((uint32_t) 0x34000010) /*!< FIFO 1 Overrun Flag         */
...
#define CAN_IT_SLK                                                           \
	((uint32_t) 0x00020000) /*!< Sleep acknowledge                           \
	                           Interrupt*/
...
#define IS_CAN_IT(IT)                                                        \
	(((IT) == CAN_IT_TME) || ((IT) == CAN_IT_FMP0) || ((IT) == CAN_IT_FF0)   \
	 ...
	 || ((IT) == CAN_IT_LEC) || ((IT) == CAN_IT_ERR) || ((IT) == CAN_IT_WKU) \
	 || ((IT) == CAN_IT_SLK))
