...
typedef struct {
	...
	FunctionalState
	    ADC_ScanConvMode; /*!< Specifies whether the conversion
	                       ...
	                       */
	FunctionalState
	    ADC_ContinuousConvMode; /*!< Specifies whether the conversion
	                                 is performed in Continuous or Single
	                               mode. This parameter can be set to ENABLE
	                               or DISABLE. */
	uint32_t
	...
	uint8_t
	    ADC_NbrOfConversion; /*!< Specifies the number of ADC conversions
...
typedef struct {
	...
	uint32_t ADC_Prescaler; /*!< Select the frequency of the clock
	                             to the ADC. The clock is common for all the
	                           ADCs. This parameter can be a value of @ref
	                           ADC_Prescaler */
	uint32_t
	...
	uint32_t
	    ADC_TwoSamplingDelay; /*!< Configures the Delay between 2 sampling
...
#define ADC_DMAAccessMode_1                                                  \
	((uint32_t) 0x00004000) /* DMA mode 1 enabled (2 / 3 half-words one by   \
	                           one - 1 then 2 then 3)*/
...
#define ADC_DMAAccessMode_3                                                  \
	((uint32_t) 0x0000C000) /* DMA mode 3 enabled (2 / 3 bytes by pairs -    \
	                           2&1 then 1&3 then 3&2) */
...
#endif /* STM32F427_437xx || STM32F429_439xx || STM32F401xx || STM32F410xx   \
          || STM32F411xE */
