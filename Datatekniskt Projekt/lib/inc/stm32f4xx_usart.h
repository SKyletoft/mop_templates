...
typedef struct {
	uint32_t USART_BaudRate; /*!< This member configures the USART
	                            ...
	                            * (USART_InitStruct->USART_BaudRate)))
	                            ...
	                            ((u32) IntegerDivider)) * 8 * (OVR8+1)) + 0.5
	...
	uint16_t USART_Mode; /*!< Specifies whether the Receive or Transmit mode
...
typedef struct {
	...
	uint16_t USART_LastBit; /*!< Specifies whether the clock pulse
	                           corresponding to the last transmitted data bit
	                           (MSB) has to be output on the SCLK pin in
	                           synchronous mode. This parameter can be a value
	                           of @ref USART_Last_Bit */
...
#define USART_IT_ORE_RX                                                      \
	((uint16_t) 0x0325) /* In case interrupt is generated if the RXNEIE bit  \
	                       is set */
...
#define USART_IT_ORE_ER                                                      \
	((uint16_t) 0x0360) /* In case interrupt is generated if the EIE bit is  \
	                       set */
...
#define IS_USART_DMAREQ(DMAREQ)                                              \
	((((DMAREQ) & (uint16_t) 0xFF3F) == 0x00)                                \
	 && ((DMAREQ) != (uint16_t) 0x00))
