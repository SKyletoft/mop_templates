 ...
 */
typedef struct {
	uint32_t HASH_AlgoSelection; /*!< SHA-1, SHA-224, SHA-256 or MD5. This
...
#define HASH_AlgoSelection_SHA256                                            \
	HASH_CR_ALGO                              /*!< HASH function is SHA256   \
	                                           */
 ...
 */
#define HASH_IT_DINI                                                         \
	HASH_IMR_DINIM /*!< A new block can be entered into the input buffer     \
	                  (DIN) */
...
#define HASH_FLAG_DINNE                                                      \
	HASH_CR_DINNE /*!< DIN not empty : The input buffer contains at least    \
	                 one word of data                 */
