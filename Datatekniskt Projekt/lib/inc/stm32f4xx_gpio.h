...
typedef struct {
	...
	GPIOOType_TypeDef GPIO_OType; /*!< Specifies the operating output type for
	                                 the selected pins. This parameter can be
	                                 a value of @ref GPIOOType_TypeDef */
...
#define GPIO_AF_LPTIM                                                        \
	((uint8_t) 0x01) /* LPTIM Alternate Function mapping                     \
	                  */
...
#define GPIO_AF_TIM10                                                        \
	((uint8_t) 0x03) /* TIM10 Alternate Function mapping                     \
	                  */
#define GPIO_AF_TIM11                                                        \
	((uint8_t) 0x03) /* TIM11 Alternate Function mapping                     \
	                  */
#if defined(STM32F446xx)
...
#define GPIO_AF4_CEC ((uint8_t) 0x04) /* CEC Alternate Function mapping */
    ...
    || defined(STM32F446xx)
#define GPIO_AF_FMPI2C                                                       \
	((uint8_t) 0x04) /* FMPI2C Alternate Function mapping */
...
#define GPIO_AF5_SPI3                                                        \
	((uint8_t) 0x05) /* SPI3/I2S3 Alternate Function mapping (Only for       \
	                    STM32F411xE and STM32F413_423xx Devices) */
#define GPIO_AF_SPI4                                                         \
...
#define GPIO_AF6_SPI1                                                        \
	((uint8_t) 0x06) /* SPI1 Alternate Function mapping (Only for            \
	                    STM32F410xx Devices) */
...
#define GPIO_AF6_SPI4                                                        \
	((uint8_t) 0x06) /* SPI4 Alternate Function mapping (Only for            \
	                    STM32F411xE Devices) */
...
#define GPIO_AF_I2S2ext                                                      \
	((uint8_t) 0x06) /* I2S2ext_SD Alternate Function mapping (only for      \
...
#define GPIO_AF_UART7                                                        \
	((uint8_t) 0x08) /* UART7 Alternate Function mapping                     \
	                  */
#define GPIO_AF_UART8                                                        \
...
#define GPIO_AF8_DFSDM1                                                      \
	((uint8_t) 0x08)                   /* DFSDM Alternate Function mapping  */
#define GPIO_AF8_CAN1 ((uint8_t) 0x08) /* CAN1 Alternate Function mapping */
#endif                                 /* STM32F412xG || STM32F413_423xx */
#if defined(STM32F446xx)
#define GPIO_AF8_SAI2 ((uint8_t) 0x08) /* SAI2 Alternate Function mapping */
#define GPIO_AF_SPDIF                                                        \
	((uint8_t) 0x08) /* SPDIF Alternate Function mapping                     \
	                  */
#endif               /* STM32F446xx */
...
#define GPIO_AF_TIM12                                                        \
	((uint8_t) 0x09) /* TIM12 Alternate Function mapping                     \
	                  */
...
#define GPIO_AF9_I2C3                                                        \
	((uint8_t) 0x09) /* I2C3 Alternate Function mapping (Only for            \
	                    STM32F401xx/STM32F411xE/STM32F412xG and              \
...
#define GPIO_AF9_FMPI2C                                                      \
	((uint8_t) 0x09) /* FMPI2C Alternate Function mapping (Only for          \
	                    STM32F410xx Devices) */
...
#define GPIO_AF_OTG_FS                                                       \
	((uint8_t) 0xA) /* OTG_FS Alternate Function mapping                     \
	                 */
#define GPIO_AF_OTG_HS                                                       \
	((uint8_t) 0xA) /* OTG_HS Alternate Function mapping                     \
	                 */
#if defined(STM32F446xx)
...
#define GPIO_AF10_DFSDM1                                                     \
	((uint8_t) 0xA) /* DFSDM Alternate Function mapping  */
#endif              /* STM32F412xG || STM32F413_423xx */
#if defined(STM32F413_423xx)
#define GPIO_AF10_DFSDM2                                                     \
	((uint8_t) 0x0A) /* DFSDM2 Alternate Function mapping */
#define GPIO_AF10_SAI1                                                       \
	((uint8_t) 0x0A) /* SAI1 Alternate Function mapping   */
#endif               /* STM32F413_423xx */
/**
...
#define GPIO_AF_ETH                                                          \
	((uint8_t) 0x0B) /* ETHERNET Alternate Function mapping                  \
	                  */
#if defined(STM32F413_423xx)
#define GPIO_AF11_UART4                                                      \
	((uint8_t) 0x0B) /* UART4 Alternate Function mapping  */
#define GPIO_AF11_UART5                                                      \
	((uint8_t) 0x0B) /* UART5 Alternate Function mapping  */
...
#define GPIO_AF11_CAN3                                                       \
	((uint8_t) 0x0B) /* CAN3 Alternate Function mapping   */
#endif               /* STM32F413_423xx */
