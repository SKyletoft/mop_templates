...
speed is configurable: 2 MHz, 25 MHz, 50 MHz or 100 MHz.
       (++) Alternate Function: Push-Pull (Pull-up, Pull-down or no Pull) Open
            Drain (Pull-up, Pull-down or no Pull).
       (++) Analog: required mode when a pin is to be used as ADC channel or
DAC output.
 ...
 * STM32F405xx/407xx and STM32F415xx/417xx devices x can be (A..I) to select
 * the GPIO peripheral for STM32F42xxx/43xxx devices. x can be (A, B, C, D and
 * H) to select the GPIO peripheral for STM32F401xx devices.
 * @retval None
 */
 ...
 *            @arg GPIO_AF_RTC_50Hz: Connect RTC_50Hz pin to AF0 (default
 * after reset)
 ...
 *            @arg GPIO_AF_SAI1: Connect SAI1 pins to AF6 for
 ...
 *            @arg GPIO_AF_FMC: Connect FMC pins to AF12 for STM32F42xxx/43xxx
 * devices.
 *            @arg GPIO_AF_OTG_HS_FS: Connect OTG HS (configured in FS) pins
 * to AF12
 *            @arg GPIO_AF_SDIO: Connect SDIO pins to AF12
 *            @arg GPIO_AF_DCMI: Connect DCMI pins to AF13
 *            @arg GPIO_AF_LTDC: Connect LTDC pins to AF14 for
