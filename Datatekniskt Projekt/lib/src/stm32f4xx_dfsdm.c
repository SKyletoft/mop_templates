...
/**
 * @brief  Deinitializes the DFSDM peripheral registers to their default reset
 * values.
 * @param  None.
 * @retval None.
 *
...
/**
 * @brief  Initializes the DFSDM serial channels transceiver  according to the
 * specified parameters in the DFSDM_TransceiverInit.
 ...
 *            @arg DFSDM2_Channel0 : DFSDM 2 Channel 0 (available only for
 * STM32F413_423xx devices)
 *            @arg DFSDM2_Channel1 : DFSDM 2 Channel 1 (available only for
 * STM32F413_423xx devices)
 *            @arg DFSDM2_Channel2 : DFSDM 2 Channel 2 (available only for
 * STM32F413_423xx devices)
 *            @arg DFSDM2_Channel3 : DFSDM 2 Channel 3 (available only for
 * STM32F413_423xx devices)
 *            @arg DFSDM2_Channel4 : DFSDM 2 Channel 4 (available only for
 * STM32F413_423xx devices)
 *            @arg DFSDM2_Channel5 : DFSDM 2 Channel 5 (available only for
 * STM32F413_423xx devices)
 *            @arg DFSDM2_Channel6 : DFSDM 2 Channel 6 (available only for
 * STM32F413_423xx devices)
 *            @arg DFSDM2_Channel7 : DFSDM 2 Channel 7 (available only for
 * STM32F413_423xx devices)
 * @param  DFSDM_TransceiverInitStruct: pointer to a
 * DFSDM_TransceiverInitTypeDef structure that contains the configuration
 * information for the specified channel.
 * @retval None
 * @note   It is mandatory to disable the selected channel to use this
 * function.
 */
void DFSDM_TransceiverInit(
    DFSDM_Channel_TypeDef *DFSDM_Channelx,
	...
	assert_param(
	    IS_DFSDM_INTERFACE(DFSDM_TransceiverInitStruct->DFSDM_Interface));
	assert_param(
	    IS_DFSDM_Input_MODE(DFSDM_TransceiverInitStruct->DFSDM_Input));
	assert_param(IS_DFSDM_Redirection_STATE(
	    DFSDM_TransceiverInitStruct->DFSDM_Redirection));
	assert_param(
	    IS_DFSDM_PACK_MODE(DFSDM_TransceiverInitStruct->DFSDM_PackingMode));
	assert_param(IS_DFSDM_CLOCK(DFSDM_TransceiverInitStruct->DFSDM_Clock));
	assert_param(IS_DFSDM_DATA_RIGHT_BIT_SHIFT(
	    DFSDM_TransceiverInitStruct->DFSDM_DataRightShift));
	assert_param(IS_DFSDM_OFFSET(DFSDM_TransceiverInitStruct->DFSDM_Offset));
	assert_param(IS_DFSDM_CLK_DETECTOR_STATE(
...
/**
 * @brief  Fills each DFSDM_TransceiverInitStruct member with its default
 * value.
 * @param  DFSDM_TransceiverInitStruct : pointer to a
 * DFSDM_TransceiverInitTypeDef structure which will be initialized.
 * @retval None
 */
void DFSDM_TransceiverStructInit(
    DFSDM_TransceiverInitTypeDef *DFSDM_TransceiverInitStruct) {
	/* SPI with rising edge to strobe data is selected as default serial
	 * interface */
	DFSDM_TransceiverInitStruct->DFSDM_Interface =
	    DFSDM_Interface_SPI_FallingEdge;

	/* Clock coming from internal DFSDM_CKOUT output is selected as default
	 * serial clock */
	...
	DFSDM_TransceiverInitStruct->DFSDM_CLKAbsenceDetector =
	    DFSDM_CLKAbsenceDetector_Enable;
}
 ...
 *            @arg DFSDM2_0 : DFSDM 2 Filter 0 (available only for
 * STM32F413_423xx devices)
 *            @arg DFSDM2_1 : DFSDM 2 Filter 1 (available only for
 * STM32F413_423xx devices)
 *            @arg DFSDM2_2 : DFSDM 2 Filter 2 (available only for
 * STM32F413_423xx devices)
 *            @arg DFSDM2_3 : DFSDM 2 Filter 3 (available only for
 * STM32F413_423xx devices)
 * @param  DFSDM_FilterInitStruct: pointer to a DFSDM_FilterInitTypeDef
 * structure that contains the configuration information for the specified
 * filter.
 * @retval None
 *
 * @note   It is mandatory to disable the selected filter to use this
 * function.
 */
void DFSDM_FilterInit(DFSDM_Filter_TypeDef *DFSDMx,
	...
	assert_param(
	    IS_DFSDM_SINC_ORDER(DFSDM_FilterInitStruct->DFSDM_SincOrder));
	assert_param(IS_DFSDM_SINC_OVRSMPL_RATIO(
	    DFSDM_FilterInitStruct->DFSDM_FilterOversamplingRatio));
	 ...
	 */
	/* Set or Reset IOSR bits according to DFSDM_IntegratorOversamplingRatio
	 * value */
	tmpreg1 |=
	    (DFSDM_FilterInitStruct->DFSDM_SincOrder
 ...
 * @retval None
 */
void DFSDM_ChannelCmd(DFSDM_Channel_TypeDef *DFSDM_Channelx,
 ...
 * @param  DFSDM_ClkOutDivision: Defines the divider for the output serial
 * clock This parameter can be a value between 1 and 256.
 * @retval None
 ...
 *         By default the serial output clock is stopped.
 */
void DFSDM_ConfigClkOutputDivider(uint32_t Instance,
                                  uint32_t DFSDM_ClkOutDivision) {
	uint32_t tmpreg1 = 0;
 ...
 * @retval None
 */
void DFSDM_ConfigClkOutputSource(uint32_t Instance,
                                 uint32_t DFSDM_ClkOutSource) {
	uint32_t tmpreg1 = 0;
...
#endif /* STM32F413_423xx */
/**
 * @brief  Enables or disables the specified Break_i siganl to the specified
 * DFSDM_Channelx.
 * @param  DFSDM_Channelx: specifies the channel to be selected.
 *         This parameter can be one of the following values :
 *            @arg DFSDM1_Channel0 : DFSDM 1 Channel 0
 ...
 *            @arg DFSDM2_Channel7 : DFSDM 2 Channel 7 (available only for
 * STM32F413_423xx devices)
 * @param  DFSDM_SCDBreak_i: where i can be a value from 0 to 3 to select the
 * specified Break signal.
 ...
 * @retval None
 */
void DFSDM_ConfigBRKShortCircuitDetector(
    DFSDM_Channel_TypeDef *DFSDM_Channelx, uint32_t DFSDM_SCDBreak_i,
    FunctionalState NewState) {
	/* Check the parameters */
	assert_param(IS_DFSDM_ALL_CHANNEL(DFSDM_Channelx));
	assert_param(IS_DFSDM_SCD_BREAK_SIGNAL(DFSDM_SCDBreak_i));
...
/**
 * @brief  Defines the threshold counter for the short circuit detector for
 * the selected DFSDM_Channelx.
 * @param  DFSDM_Channelx: specifies the channel to be selected.
 *         This parameter can be one of the following values :
 *            @arg DFSDM1_Channel0 : DFSDM 1 Channel 0
 *            @arg DFSDM1_Channel1 : DFSDM 1 Channel 1
 ...
 *            @arg DFSDM2_Channel7 : DFSDM 2 Channel 7 (available only for
 * STM32F413_423xx devices)
 * @param  DFSDM_SCDThreshold: The threshold counter, this parameter can be a
...
/**
 * @brief  Selects the channel to be guarded by the Analog watchdog for the
 * selected DFSDMx, and select if the fast analog watchdog is enabled or not.
 * @param  DFSDMx: specifies the filter to be selected :
 *         This parameter can be one of the following values :
 *            @arg DFSDM1_0 : DFSDM 1 Filter 0
 *            @arg DFSDM1_1 : DFSDM 1 Filter 1
 ...
 *            @arg DFSDM2_3 : DFSDM 2 Filter 3 (available only for
 * STM32F413_423xx devices)
 * @param  DFSDM_AWDChannelx: where x can be a value from 0 to 7 to select the
 * DFSDM Channel.
 * @param  DFSDM_AWDFastMode: The analog watchdog fast mode.
 *         This parameter can be a value of @ref
 * DFSDM_AWD_Fast_Mode_Selection.
 * @retval None
 */
void DFSDM_ConfigAnalogWatchdog(DFSDM_Filter_TypeDef *DFSDMx,
                                uint32_t DFSDM_AWDChannelx,
...
/**
 * @brief  Selects the channel to be guarded by the Analog watchdog of the
 * selected DFSDMx, and the mode to be used.
 * @param  DFSDMx: specifies the filter to be selected :
 *         This parameter can be one of the following values :
 *            @arg DFSDM1_0 : DFSDM 1 Filter 0
 *            @arg DFSDM1_1 : DFSDM 1 Filter 1
 ...
 *            @arg DFSDM2_3 : DFSDM 2 Filter 3 (available only for
 * STM32F413_423xx devices)
 * @param  DFSDM_ExtremChannelx: where x can be a value from 0 to 7 to select
 * the Channel to be connected to the Extremes detector.
 * @retval None
 */
...
/**
 * @brief  Returns the number of channel on which is captured the highest
 * converted data by the DFSDMx.
 * @param  DFSDMx: specifies the filter to be selected :
 *         This parameter can be one of the following values :
 *            @arg DFSDM1_0 : DFSDM 1 Filter 0
 *            @arg DFSDM1_1 : DFSDM 1 Filter 1
...
/**
 * @brief  Returns the number of channel on which is captured the lowest
 * converted data by the DFSDMx.
 * @param  DFSDMx: specifies the filter to be selected :
 *         This parameter can be one of the following values :
 *            @arg DFSDM1_0 : DFSDM 1 Filter 0
 ...
 *         the Sinc filter order and the Oversampling ratio for the specified
 * DFSDM_Channelx.
 * @param  DFSDM_Channelx: specifies the channel to be selected.
 *         This parameter can be one of the following values :
 *            @arg DFSDM1_Channel0 : DFSDM 1 Channel 0
 ...
 *            @arg DFSDM2_Channel7 : DFSDM 2 Channel 7 (available only for
 * STM32F413_423xx devices)
 * @param  DFSDM_AWDSincOrder: The Sinc Filter order this parameter can be a
 * value of @ref DFSDM_AWD_Sinc_Order.
 * @param  DFSDM_AWDSincOverSampleRatio: The Filter Oversampling ratio, this
...
void DFSDM_ConfigAWDFilter(DFSDM_Channel_TypeDef *DFSDM_Channelx,
	...
	/* Set or Reset the SCDT bits */
	tmpreg1 |=
	    (DFSDM_AWDSincOrder | ((DFSDM_AWDSincOverSampleRatio - 1) << 16));
...
/**
 * @brief  Returns the last Analog Watchdog Filter conversion result data for
 * channelx.
 * @param  DFSDM_Channelx: specifies the channel to be selected.
 *         This parameter can be one of the following values :
 *            @arg DFSDM1_Channel0 : DFSDM 1 Channel 0
...
/**
 * @brief  Configures the High Threshold and the Low threshold for the Analog
 * watchdog of the selected DFSDMx.
 * @param  DFSDMx: specifies the filter to be selected :
 *         This parameter can be one of the following values :
 *            @arg DFSDM1_0 : DFSDM 1 Filter 0
 *            @arg DFSDM1_1 : DFSDM 1 Filter 1
 ...
 *            @arg DFSDM2_3 : DFSDM 2 Filter 3 (available only for
 * STM32F413_423xx devices)
 * @param  DFSDM_HighThreshold: High threshold value. This parameter can be
 * value between 0 and 0xFFFFFF.
 * @param  DFSDM_LowThreshold: Low threshold value. This parameter can be
 * value between 0 and 0xFFFFFF.
 * @retval None.
 * @note   In case of channels transceivers monitoring (Analog Watchdog fast
 * mode Enabled)), only the higher 16 bits define the 16-bit threshold
 * compared with analog watchdog filter output.
 */

void DFSDM_SetAWDThreshold(DFSDM_Filter_TypeDef *DFSDMx,
                           uint32_t DFSDM_HighThreshold,
 ...
 *            @arg DFSDM2_3 : DFSDM 2 Filter 3 (available only for
 * STM32F413_423xx devices)
 * @param  DFSDM_InjectedChannelx: where x can be a value from 0 to 7 to
 * select the Channel to be configuraed as injected channel.
 * @retval None
 * @note   User can select up to 8 channels.
 */
void DFSDM_SelectInjectedChannel(DFSDM_Filter_TypeDef *DFSDMx,
                                 uint32_t DFSDM_InjectedChannelx) {
	uint32_t tmpreg1 = 0;
 ...
 *            @arg DFSDM2_3 : DFSDM 2 Filter 3 (available only for
 * STM32F413_423xx devices)
 * @param  DFSDM_RegularChannelx: where x can be a value from 0 to 7 to select
 * the Channel to be configurated as regular channel.
 * @retval None
 * @note   User can select only one channel.
 */
void DFSDM_SelectRegularChannel(DFSDM_Filter_TypeDef *DFSDMx,
                                uint32_t DFSDM_RegularChannelx) {
	uint32_t tmpreg1 = 0;
...
/**
 * @brief  Starts a software start for the injected group of channels of the
 * selected DFSDMx.
 * @param  DFSDMx: specifies the filter to be selected :
 *         This parameter can be one of the following values :
 *            @arg DFSDM1_0 : DFSDM 1 Filter 0
...
/**
 * @brief  Starts a software start of the regular channel of the selected
 * DFSDMx.
 * @param  DFSDMx: specifies the filter to be selected :
 *         This parameter can be one of the following values :
 *            @arg DFSDM1_0 : DFSDM 1 Filter 0
...
/**
 * @brief  Selects the Trigger signal to launch the injected conversions of
 * the selected DFSDMx.
 * @param  DFSDMx: specifies the filter to be selected :
 *         This parameter can be one of the following values :
 *            @arg DFSDM1_0 : DFSDM 1 Filter 0
 ...
 * @retval None.
 * @note   This function can be used only when the filter is disabled, use
 * DFSDM_FilterCmd() to disable the filter.
 */
void DFSDM_ConfigInjectedTrigger(DFSDM_Filter_TypeDef *DFSDMx,
                                 uint32_t DFSDM_Trigger,
...
/**
 * @brief  Enables or Disables the continue mode for Regular conversion for
 * the selected filter DFSDMx.
 * @param  DFSDMx: specifies the filter to be selected :
 *         This parameter can be one of the following values :
 *            @arg DFSDM1_0 : DFSDM 1 Filter 0
 *            @arg DFSDM1_1 : DFSDM 1 Filter 1
 ...
 * @retval None
 */
void DFSDM_RegularContinuousModeCmd(DFSDM_Filter_TypeDef *DFSDMx,
                                    FunctionalState NewState) {
	/* Check the parameters */
	assert_param(IS_DFSDM_ALL_FILTER(DFSDMx));
	assert_param(IS_FUNCTIONAL_STATE(NewState));
 ...
 *         This parameter can be: ENABLE or DISABLE.
 * @retval None
 * @note   If just a single channel is selected in continuous mode (either by
 * executing a regular conversion or by executing a injected conversion with
 * only one channel selected), the sampling rate can be increased several
 * times by enabling the fast mode.
 * @note   This function can be used only when the filter is disabled, use
 * DFSDM_FilterCmd() to disable the filter.
 */
void DFSDM_FastModeCmd(DFSDM_Filter_TypeDef *DFSDMx,
                       FunctionalState NewState) {
	/* Check the parameters */
	assert_param(IS_DFSDM_ALL_FILTER(DFSDMx));
	assert_param(IS_FUNCTIONAL_STATE(NewState));
 ...
 *            @arg DFSDM2_3 : DFSDM 2 Filter 3 (available only for
 * STM32F413_423xx devices)
 * @param  DFSDM_InjectConvMode: The injected conversion mode, this parameter
 * can be:
...
/**
 * @brief  Enables or Disables the DMA to read data for the injected channel
 * group of the selected filter DFSDMx.
 * @param  DFSDMx: specifies the filter to be selected :
 *         This parameter can be one of the following values :
 *            @arg DFSDM1_0 : DFSDM 1 Filter 0
 *            @arg DFSDM1_1 : DFSDM 1 Filter 1
 ...
 *            @arg DFSDM2_3 : DFSDM 2 Filter 3 (available only for
 * STM32F413_423xx devices)
 * @param  DFSDM_DMAConversionMode: Selects the mode to be configured for DMA
 * read  .
 *            @arg DFSDM_DMAConversionMode_Regular:  DMA channel
 * Enabled/Disabled to read data for the regular conversion
 *            @arg DFSDM_DMAConversionMode_Injected: DMA channel
 * Enabled/Disabled to read data for the Injected conversion
 ...
 * DFSDM_FilterCmd() to disable the filter.
 */
void DFSDM_DMATransferConfig(DFSDM_Filter_TypeDef *DFSDMx,
                             uint32_t DFSDM_DMAConversionMode,
                             FunctionalState NewState) {
	/* Check the parameters */
	assert_param(IS_DFSDM_ALL_FILTER(DFSDMx));
...
@verbatim
 ===============================================================================
                  Interrupts and flags management functions
 ===============================================================================
  This section provides functions allowing to configure the DFSDM Interrupts,
get the status and clear flags bits.

  The LPT provides 7 Flags and Interrupts sources (2 flags and Interrupt
sources are available only on LPT peripherals equipped with encoder mode
interface)
...
"DFSDM_GetITStatus","DFSDM_GetClockAbsenceITStatusfunction" and
"DFSDM_GetGetShortCircuitITStatus" functions and read returned values.
  - To get a flag status, call the "DFSDM_GetFlagStatus"
,"DFSDM_GetClockAbsenceFlagStatus" ,"DFSDM_GetShortCircuitFlagStatus" and
"DFSDM_GetWatchdogFlagStatus" functions and read the returned value.
  - To clear a flag or an interrupt, use
DFSDM_ClearFlag,DFSDM_ClearClockAbsenceFlag,
    DFSDM_ClearShortCircuitFlag,DFSDM_ClearAnalogWatchdogFlag functions with
the corresponding flag (interrupt).
 ...
 *            @arg DFSDM2_3 : DFSDM 2 Filter 3 (available only for
 * STM32F413_423xx devices)
 * @param  DFSDM_IT: specifies the DFSDM interrupts sources to be enabled or
 ...
 * @retval None
 */
void DFSDM_ITConfig(DFSDM_Filter_TypeDef *DFSDMx, uint32_t DFSDM_IT,
                    FunctionalState NewState) {
	/* Check the parameters */
	assert_param(IS_DFSDM_ALL_FILTER(DFSDMx));
 ...
 * @retval None
 */
void DFSDM_ITShortCircuitDetectorCmd(uint32_t Instance,
                                     FunctionalState NewState) {
	/* Check the parameters */
	assert_param(IS_FUNCTIONAL_STATE(NewState));
 ...
 * @retval None
 */
FlagStatus DFSDM_GetFlagStatus(DFSDM_Filter_TypeDef *DFSDMx,
                               uint32_t DFSDM_FLAG) {
...
#if defined(STM32F412xG)
/**
 * @brief  Checks whether the specified Clock Absence Channel flag is set or
 * not.
 * @param  DFSDM_FLAG_CLKAbsence: specifies the flag to check.
 *         This parameter can be a value of @ref
 * DFSDM_Clock_Absence_Flag_Definition
 * @retval None
 */
...
/**
 * @brief  Checks whether the specified Short Circuit Channel Detector flag is
 * set or not.
 ...
 * @retval None
 */
FlagStatus DFSDM_GetClockAbsenceFlagStatus(uint32_t Instance,
                                           uint32_t DFSDM_FLAG_CLKAbsence) {
	ITStatus bitstatus = RESET;
 ...
 * @retval None
 */
FlagStatus DFSDM_GetShortCircuitFlagStatus(uint32_t Instance,
                                           uint32_t DFSDM_FLAG_SCD) {
	ITStatus bitstatus = RESET;
 ...
 * @retval None
 */
FlagStatus DFSDM_GetWatchdogFlagStatus(DFSDM_Filter_TypeDef *DFSDMx,
                                       uint32_t DFSDM_AWDChannelx,
	...
	if ((DFSDMx->FLTAWSR & ((DFSDM_AWDChannelx >> 16) << DFSDM_Threshold))
	    != RESET) {
		bitstatus = SET;
	} else {
		bitstatus = RESET;
 ...
 * DFSDM_Clear_ClockAbs_Flag_Definition
 * @retval None
 */
 ...
 *         This parameter can be any combination of @ref
 * DFSDM_Clear_Short_Circuit_Flag_Definition
 * @retval None
 */
 ...
 * @retval None
 */
void DFSDM_ClearClockAbsenceFlag(uint32_t Instance,
                                 uint32_t DFSDM_CLEARF_CLKAbsence) {
	/* Check the parameters */
	assert_param(IS_DFSDM_CLK_ABS_CLEARF(DFSDM_CLEARF_CLKAbsence));
 ...
 * @retval None
 */
void DFSDM_ClearShortCircuitFlag(uint32_t Instance,
                                 uint32_t DFSDM_CLEARF_SCD) {
	/* Check the parameters */
	assert_param(IS_DFSDM_SCD_CHANNEL_FLAG(DFSDM_CLEARF_SCD));
 ...
 * @retval None
 */
void DFSDM_ClearAnalogWatchdogFlag(DFSDM_Filter_TypeDef *DFSDMx,
                                   uint32_t DFSDM_AWDChannelx,
                                   uint8_t DFSDM_Threshold) {
	/* Check the parameters */
	assert_param(IS_DFSDM_ALL_FILTER(DFSDMx));
...
#if defined(STM32F412xG)
/**
 * @brief  Check whether the specified Clock Absence channel interrupt has
 * occurred or not.
 * @param  DFSDM_IT_CLKAbsence: specifies on which channel check the interrupt
 * source. This parameter can be a value of @ref
 * DFSDM_Clock_Absence_Interrupt_Definition.
 * @retval The new state of DFSDM_IT (SET or RESET).
...
/**
 * @brief  Check whether the specified Short Circuit channel interrupt has
 * occurred or not.
 * @param  DFSDM_IT_SCR: specifies on which channel check the interrupt
 * source. This parameter can be a value of @ref
 * DFSDM_SCD_Interrupt_Definition.
 * @retval The new state of DFSDM_IT (SET or RESET).
 ...
 * @note   Clock absence interrupt is handled only by DFSDM0.
 */
ITStatus DFSDM_GetClockAbsenceITStatus(uint32_t Instance,
                                       uint32_t DFSDM_IT_CLKAbsence) {
	ITStatus bitstatus = RESET;
	uint32_t itstatus = 0x0, itenable = 0x0;
 ...
 */
ITStatus DFSDM_GetShortCircuitITStatus(uint32_t Instance,
                                       uint32_t DFSDM_IT_SCR) {
	ITStatus bitstatus = RESET;
	uint32_t itstatus = 0x0, itenable = 0x0;
