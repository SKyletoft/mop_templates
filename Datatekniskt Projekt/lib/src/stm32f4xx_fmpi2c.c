/**
  ...
  *          functionalities of the Inter-Integrated circuit Fast Mode Plus
 (FMPI2C):
 ...
 RCC_APB1PeriphClockCmd(RCC_APB1Periph_I2Cx, ENABLE) function for FMPI2C
 peripheral.
   ...
   (#) Optionally you can enable/configure the following parameters without
       re-initialization (i.e there is no need to call again FMPI2C_Init()
 function):
       (++) Enable the acknowledge feature using FMPI2C_AcknowledgeConfig()
 function.
       (++) Enable the dual addressing mode using FMPI2C_DualAddressCmd()
 function.
       (++) Enable the general call using the FMPI2C_GeneralCallCmd()
 function.
       (++) Enable the clock stretching using FMPI2C_StretchClockCmd()
 function.
       (++) Enable the PEC Calculation using FMPI2C_CalculatePEC() function.
       (++) For SMBus Mode:
            (+++) Enable the SMBusAlert pin using FMPI2C_SMBusAlertCmd()
 function.
   ...
   (#) Enable the DMA using the DMA_Cmd() function when using DMA mode in the
       transfers.
   [..]
   (@) When using FMPI2C in Fast Mode Plus, SCL and SDA pin 20mA current drive
 capability must be enabled by setting the driving capability control bit in
 SYSCFG.
...
#define CR1_CLEAR_MASK                                                       \
	((uint32_t) 0x00CFE0FF) /*<! FMPI2C CR1 clear register Mask */
#define CR2_CLEAR_MASK                                                       \
	((uint32_t) 0x07FF7FFF) /*<! FMPI2C CR2 clear register Mask */
#define TIMING_CLEAR_MASK                                                    \
	((uint32_t) 0xF0FFFFFF) /*<! FMPI2C TIMING clear register Mask */
#define ERROR_IT_MASK                                                        \
	((uint32_t) 0x00003F00) /*<! FMPI2C Error interrupt register Mask */
#define TC_IT_MASK                                                           \
	((uint32_t) 0x000000C0) /*<! FMPI2C TC interrupt register Mask */
...
@verbatim
 ...
 ===============================================================================
    [..] This section provides a set of functions allowing to initialize the
FMPI2C Mode, FMPI2C Timing, FMPI2C filters, FMPI2C Addressing mode, FMPI2C
OwnAddress1.

    [..] The FMPI2C_Init() function follows the FMPI2C configuration
procedures (these procedures are available in reference manual).

    [..] When the Software Reset is performed using FMPI2C_SoftwareResetCmd()
function, the internal states machines are reset and communication control
bits, as well as status bits come back to their reset value.

    [..] Before enabling Stop mode using FMPI2C_StopModeCmd() FMPI2C Clock
source must be set to HSI and Digital filters must be disabled.

    [..] Before enabling Own Address 2 via FMPI2C_DualAddressCmd() function,
OA2 and mask should be configured using FMPI2C_OwnAddress2Config() function.

    [..] FMPI2C_SlaveByteControlCmd() enable Slave byte control that allow
user to get control of each byte in slave mode when NBYTES is set to 0x01.
...
/**
 * @brief  Deinitializes the FMPI2Cx peripheral registers to their default
 * reset values.
 ...
 *         contains the configuration information for the specified FMPI2C
 * peripheral.
 * @retval None
 */
void FMPI2C_Init(FMPI2C_TypeDef *FMPI2Cx,
	...
	assert_param(IS_FMPI2C_ALL_PERIPH(FMPI2Cx));
	assert_param(
	    IS_FMPI2C_ANALOG_FILTER(FMPI2C_InitStruct->FMPI2C_AnalogFilter));
	assert_param(
	    IS_FMPI2C_DIGITAL_FILTER(FMPI2C_InitStruct->FMPI2C_DigitalFilter));
	assert_param(IS_FMPI2C_MODE(FMPI2C_InitStruct->FMPI2C_Mode));
	assert_param(
	    IS_FMPI2C_OWN_ADDRESS1(FMPI2C_InitStruct->FMPI2C_OwnAddress1));
	assert_param(IS_FMPI2C_ACK(FMPI2C_InitStruct->FMPI2C_Ack));
	assert_param(IS_FMPI2C_ACKNOWLEDGE_ADDRESS(
	    FMPI2C_InitStruct->FMPI2C_AcknowledgedAddress));
	...
	tmpreg =
	    (uint32_t) ((uint32_t) FMPI2C_InitStruct->FMPI2C_AcknowledgedAddress
 ...
 * @param  FMPI2C_InitStruct: pointer to an FMPI2C_InitTypeDef structure which
 * will be initialized.
 * @retval None
 */
void FMPI2C_StructInit(FMPI2C_InitTypeDef *FMPI2C_InitStruct) {
	...
	FMPI2C_InitStruct->FMPI2C_AcknowledgedAddress =
	    FMPI2C_AcknowledgedAddress_7bit;
}
 ...
 * @param  FMPI2Cx: where x can be 1 to select the FMPI2C peripheral.
 * @param  FMPI2C_IT: specifies the FMPI2C interrupts sources to be enabled or
 ...
 * @retval None
 */
void FMPI2C_ITConfig(FMPI2C_TypeDef *FMPI2Cx, uint32_t FMPI2C_IT,
 ...
 * @retval None
 */
void FMPI2C_StretchClockCmd(FMPI2C_TypeDef *FMPI2Cx,
                            FunctionalState NewState) {
	/* Check the parameters */
	assert_param(IS_FMPI2C_ALL_PERIPH(FMPI2Cx));
	assert_param(IS_FUNCTIONAL_STATE(NewState));
 ...
 * @retval None
 */
void FMPI2C_DualAddressCmd(FMPI2C_TypeDef *FMPI2Cx,
                           FunctionalState NewState) {
	/* Check the parameters */
	assert_param(IS_FMPI2C_ALL_PERIPH(FMPI2Cx));
	assert_param(IS_FUNCTIONAL_STATE(NewState));
 ...
 * @retval None
 */
void FMPI2C_OwnAddress2Config(FMPI2C_TypeDef *FMPI2Cx, uint16_t Address,
                              uint8_t Mask) {
	uint32_t tmpreg = 0;
 ...
 * @retval None
 */
void FMPI2C_GeneralCallCmd(FMPI2C_TypeDef *FMPI2Cx,
                           FunctionalState NewState) {
	/* Check the parameters */
	assert_param(IS_FMPI2C_ALL_PERIPH(FMPI2Cx));
	assert_param(IS_FUNCTIONAL_STATE(NewState));
 ...
 * @retval None
 */
void FMPI2C_SlaveByteControlCmd(FMPI2C_TypeDef *FMPI2Cx,
                                FunctionalState NewState) {
	/* Check the parameters */
	assert_param(IS_FMPI2C_ALL_PERIPH(FMPI2Cx));
	assert_param(IS_FUNCTIONAL_STATE(NewState));
...
/**
 * @brief  Configures the slave address to be transmitted after start
 * generation.
 * @param  FMPI2Cx: where x can be 1 to select the FMPI2C peripheral.
 * @param  Address: specifies the slave address to be programmed.
...
/**
 * @brief  Enables or disables the FMPI2C 10-bit addressing mode for the
 * master.
 * @param  FMPI2Cx: where x can be 1 to select the FMPI2C peripheral.
 ...
 * @retval None
 */
void FMPI2C_10BitAddressingModeCmd(FMPI2C_TypeDef *FMPI2Cx,
                                   FunctionalState NewState) {
	/* Check the parameters */
	assert_param(IS_FMPI2C_ALL_PERIPH(FMPI2Cx));
	assert_param(IS_FUNCTIONAL_STATE(NewState));
...
@verbatim
 ...
 ===============================================================================
    [..] This section provides a set of functions that handles FMPI2C
communication.

    [..] Automatic End mode is enabled using FMPI2C_AutoEndCmd() function.
When Reload mode is enabled via FMPI2C_ReloadCmd() AutoEnd bit has no effect.

    [..] FMPI2C_NumberOfBytesConfig() function set the number of bytes to be
transferred, this configuration should be done before generating start
condition in master mode.

    [..] When switching from master write operation to read operation in 10Bit
addressing mode, master can only sends the 1st 7 bits of the 10 bit address,
followed by Read direction by enabling HEADR bit using
FMPI2C_10BitAddressHeader() function.

    [..] In master mode, when transferring more than 255 bytes Reload mode
should be used to handle communication. In the first phase of transfer, Nbytes
should be set to 255. After transferring these bytes TCR flag is set and
FMPI2C_TransferHandling() function should be called to handle remaining
communication.

    [..] In master mode, when software end mode is selected when all data is
transferred TC flag is set FMPI2C_TransferHandling() function should be called
to generate STOP or generate ReStart.
...
/**
 * @brief  Enables or disables the FMPI2C automatic end mode (stop condition
 ...
 * @retval None
 */
void FMPI2C_NumberOfBytesConfig(FMPI2C_TypeDef *FMPI2Cx,
	...
	/* Set FMPI2Cx Nbytes */
	tmpreg |=
	    (uint32_t) (((uint32_t) Number_Bytes << 16) & FMPI2C_CR2_NBYTES);
 ...
 * @param  FMPI2Cx: where x can be 1 to select the FMPI2C peripheral.
 * @param  FMPI2C_Direction: specifies the transfer request direction to be
 * programmed. This parameter can be one of the following values:
 ...
 * @retval None
 */
void FMPI2C_MasterRequestConfig(FMPI2C_TypeDef *FMPI2Cx,
                                uint16_t FMPI2C_Direction) {
	/* Check the parameters */
	assert_param(IS_FMPI2C_ALL_PERIPH(FMPI2Cx));
...
/**
 * @brief  Enables or disables the FMPI2C 10-bit header only mode with read
 * direction.
 * @param  FMPI2Cx: where x can be 1 to select the FMPI2C peripheral.
 * @param  NewState: new state of the FMPI2C 10-bit header only mode.
 *   This parameter can be: ENABLE or DISABLE.
 * @note   This mode can be used only when switching from master transmitter
 * mode to master receiver mode.
 * @retval None
 */
void FMPI2C_10BitAddressHeaderCmd(FMPI2C_TypeDef *FMPI2Cx,
                                  FunctionalState NewState) {
	/* Check the parameters */
	assert_param(IS_FMPI2C_ALL_PERIPH(FMPI2Cx));
	assert_param(IS_FUNCTIONAL_STATE(NewState));
 ...
 * @retval None
 */
void FMPI2C_AcknowledgeConfig(FMPI2C_TypeDef *FMPI2Cx,
                              FunctionalState NewState) {
	/* Check the parameters */
	assert_param(IS_FMPI2C_ALL_PERIPH(FMPI2Cx));
	assert_param(IS_FUNCTIONAL_STATE(NewState));
...
/**
 * @brief  Handles FMPI2Cx communication when starting transfer or during
 ...
 *     @arg FMPI2C_Generate_Stop: Generate stop condition (Number_Bytes should
 * be set to 0).
...
void FMPI2C_TransferHandling(FMPI2C_TypeDef *FMPI2Cx, uint16_t Address,
	...
	tmpreg &= (uint32_t) ~(
	    (uint32_t) (FMPI2C_CR2_SADD | FMPI2C_CR2_NBYTES | FMPI2C_CR2_RELOAD
	                | FMPI2C_CR2_AUTOEND | FMPI2C_CR2_RD_WRN
	                | FMPI2C_CR2_START | FMPI2C_CR2_STOP));

	/* update tmpreg */
	tmpreg |=
	    (uint32_t) (((uint32_t) Address & FMPI2C_CR2_SADD)
...
@verbatim
 ...
 ===============================================================================
    [..] This section provides a set of functions that handles SMBus
communication and timeouts detection.

    [..] The SMBus Device default address (0b1100 001) is enabled by calling
FMPI2C_Init() function and setting FMPI2C_Mode member of FMPI2C_InitTypeDef()
structure to FMPI2C_Mode_SMBusDevice.

    [..] The SMBus Host address (0b0001 000) is enabled by calling
FMPI2C_Init() function and setting FMPI2C_Mode member of FMPI2C_InitTypeDef()
structure to FMPI2C_Mode_SMBusHost.

    [..] The Alert Response Address (0b0001 100) is enabled using
FMPI2C_SMBusAlertCmd() function.

    [..] To detect cumulative SCL stretch in master and slave mode, TIMEOUTB
should be configured (in accordance to SMBus specification) using
FMPI2C_TimeoutBConfig() function then FMPI2C_ExtendedClockTimeoutCmd()
function should be called to enable the detection.

    [..] SCL low timeout is detected by configuring TIMEOUTB using
FMPI2C_TimeoutBConfig() function followed by the call of
FMPI2C_ClockTimeoutCmd(). When adding to this procedure the call of
FMPI2C_IdleClockTimeoutCmd() function, Bus Idle condition (both SCL and SDA
 ...
 * @retval None
 */
void FMPI2C_ClockTimeoutCmd(FMPI2C_TypeDef *FMPI2Cx,
                            FunctionalState NewState) {
	/* Check the parameters */
	assert_param(IS_FMPI2C_ALL_PERIPH(FMPI2Cx));
	assert_param(IS_FUNCTIONAL_STATE(NewState));
	...
	if (NewState != DISABLE) {
		...
		FMPI2Cx->TIMEOUTR &=
		    (uint32_t) ~((uint32_t) FMPI2C_TIMEOUTR_TIMOUTEN);
	}
}

/**
 * @brief  Enables or disables FMPI2C Extended Clock Timeout (SCL cumulative
 * Timeout detection).
 * @param  FMPI2Cx: where x can be 1 to select the FMPI2C peripheral.
 ...
 * @retval None
 */
void FMPI2C_ExtendedClockTimeoutCmd(FMPI2C_TypeDef *FMPI2Cx,
                                    FunctionalState NewState) {
	/* Check the parameters */
	assert_param(IS_FMPI2C_ALL_PERIPH(FMPI2Cx));
	assert_param(IS_FUNCTIONAL_STATE(NewState));
 ...
 * @retval None
 */
void FMPI2C_IdleClockTimeoutCmd(FMPI2C_TypeDef *FMPI2Cx,
                                FunctionalState NewState) {
	/* Check the parameters */
	assert_param(IS_FMPI2C_ALL_PERIPH(FMPI2Cx));
	assert_param(IS_FUNCTIONAL_STATE(NewState));
...
/**
 * @brief  Configures the FMPI2C Bus Timeout A (SCL Timeout when TIDLE = 0 or
 * Bus idle SCL and SDA high when TIDLE = 1).
 * @param  FMPI2Cx: where x can be 1 to select the FMPI2C peripheral.
...
void FMPI2C_TimeoutBConfig(FMPI2C_TypeDef *FMPI2Cx, uint16_t Timeout) {
	...
	tmpreg |=
	    (uint32_t) (((uint32_t) Timeout << 16) & FMPI2C_TIMEOUTR_TIMEOUTB);
 ...
 */
uint32_t FMPI2C_ReadRegister(FMPI2C_TypeDef *FMPI2Cx,
                             uint8_t FMPI2C_Register) {
	__IO uint32_t tmp = 0;
...
@verbatim
 ...
 ===============================================================================
    ...
    [..] The read access of the FMPI2C_RXDR register can be done using
         ...
         Whereas a write access to the FMPI2C_TXDR can be done using
FMPI2C_SendData() function and stores the written data into TXDR.
@endverbatim
  * @{
  */
...
@verbatim
 ...
 ===============================================================================
    [..] This section provides two functions that can be used only in DMA
mode.
    ...
    [..] In this Mode it is advised to use the following function:
         (+) FMPI2C_DMACmd(FMPI2C_TypeDef* FMPI2Cx, uint32_t FMPI2C_DMAReq,
FunctionalState NewState);
@endverbatim
  * @{
  */
 ...
 * @param  FMPI2Cx: where x can be 1 to select the FMPI2C peripheral.
 * @param  FMPI2C_DMAReq: specifies the FMPI2C DMA transfer request to be
...
@verbatim
 ...
 ===============================================================================
    [..] This section provides functions allowing to configure the FMPI2C
Interrupts sources and check or clear the flags or pending bits status. The
user should identify which mode will be used in his application to manage the
communication: Polling mode, Interrupt mode or DMA mode(refer FMPI2C_Group6) .

  *** Polling Mode ***
  ====================
    [..] In Polling Mode, the FMPI2C communication can be managed by 15 flags:
        (#) FMPI2C_FLAG_TXE: to indicate the status of Transmit data register
empty flag.
        (#) FMPI2C_FLAG_TXIS: to indicate the status of Transmit interrupt
status flag .
        (#) FMPI2C_FLAG_RXNE: to indicate the status of Receive data register
not empty flag.
        (#) FMPI2C_FLAG_ADDR: to indicate the status of Address matched flag
(slave mode).
        ...
        (#) FMPI2C_FLAG_TC: to indicate the status of Transfer complete
flag(master mode).
        (#) FMPI2C_FLAG_TCR: to indicate the status of Transfer complete
reload flag.
        ...
        (#) FMPI2C_FLAG_PECERR: to indicate the status of PEC error in
reception flag.
        (#) FMPI2C_FLAG_TIMEOUT: to indicate the status of Timeout or Tlow
detection flag.
    ...
    [..] In this Mode it is advised to use the following functions:
        (+) FlagStatus FMPI2C_GetFlagStatus(FMPI2C_TypeDef* FMPI2Cx, uint32_t
FMPI2C_FLAG);
        (+) void FMPI2C_ClearFlag(FMPI2C_TypeDef* FMPI2Cx, uint32_t
FMPI2C_FLAG);

    [..]
        (@)Do not use the BUSY flag to handle each data transmission or
reception.It is better to use the TXIS and RXNE flags instead.

  *** Interrupt Mode ***
  ======================
    [..] In Interrupt Mode, the FMPI2C communication can be managed by 7
interrupt sources and 15 pending bits:
    [..] Interrupt Source:
        (#) FMPI2C_IT_ERRI: specifies the interrupt source for the Error
interrupt.
        (#) FMPI2C_IT_TCI: specifies the interrupt source for the Transfer
Complete interrupt.
        (#) FMPI2C_IT_STOPI: specifies the interrupt source for the Stop
Detection interrupt.
        (#) FMPI2C_IT_NACKI: specifies the interrupt source for the Not
Acknowledge received interrupt.
        (#) FMPI2C_IT_ADDRI: specifies the interrupt source for the Address
Match interrupt.
        (#) FMPI2C_IT_RXI: specifies the interrupt source for the RX
interrupt.
        (#) FMPI2C_IT_TXI: specifies the interrupt source for the TX
interrupt.

    [..] Pending Bits:
        (#) FMPI2C_IT_TXIS: to indicate the status of Transmit interrupt
status flag.
        (#) FMPI2C_IT_RXNE: to indicate the status of Receive data register
not empty flag.
        (#) FMPI2C_IT_ADDR: to indicate the status of Address matched flag
(slave mode).
        ...
        (#) FMPI2C_IT_TC: to indicate the status of Transfer complete flag
(master mode).
        (#) FMPI2C_IT_TCR: to indicate the status of Transfer complete reload
flag.
        ...
        (#) FMPI2C_IT_PECERR: to indicate the status of PEC error in reception
flag.
        (#) FMPI2C_IT_TIMEOUT: to indicate the status of Timeout or Tlow
detection flag.
        (#) FMPI2C_IT_ALERT: to indicate the status of SMBus Alert flag.

    [..] In this Mode it is advised to use the following functions:
         (+) void FMPI2C_ClearITPendingBit(FMPI2C_TypeDef* FMPI2Cx, uint32_t
FMPI2C_IT);
         (+) ITStatus FMPI2C_GetITStatus(FMPI2C_TypeDef* FMPI2Cx, uint32_t
FMPI2C_IT);
 ...
 */
FlagStatus FMPI2C_GetFlagStatus(FMPI2C_TypeDef *FMPI2Cx,
                                uint32_t FMPI2C_FLAG) {
	uint32_t tmpreg      = 0;
